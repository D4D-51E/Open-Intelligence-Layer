...
// over a wider window. Small, capped, and NOT a TRUE-qualifying source type — nudges 가능성 where a
// region genuinely has recent fire activity, without treating region-wide fire as a confirmed strike.
...
export function assess(
  ...
  // counted, to avoid double-counting the same fires. Does NOT add a source type (never reaches TRUE alone).
