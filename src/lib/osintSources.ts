...
export const osintSourceCatalog: OsintSourceCatalogEntry[] = [
  ...
  },
  {
    ...
    family: 'track',
    tier: 'public-no-key',
    role: '무키 커뮤니티 ADS-B — 지역 point 피드 + 전세계 군용 전용(/v2/mil) 피드',
    url: 'https://api.adsb.lol/docs',
    mode: '브라우저 라이브 폴링(30초); 군용 피드는 AOI 교집합',
    verdictUse: '군용·특수 항공기 커버리지 보강과 다중 ADS-B 소스 교차 확인',
    caveat: '커뮤니티 수신기 기반이라 커버리지가 불완전하며, 군용 표시는 공개 dbFlags 노출입니다.',
  },
  {
    id: 'celestrak',
  ...
  {
    id: 'icao-notam',
    name: 'ICAO/SkyLink NOTAM',
    family: 'airspace',
    tier: 'free-key',
    role: '공역 폐쇄·위험구역·항행 공지 확인',
    url: 'https://dataservices.icao.int/, https://skylink-api.p.rapidapi.com/',
    mode: 'SkyLink API 키가 있으면 /notams/{icao} 우선 호출, 없으면 ICAO_NOTAM_ENDPOINT로 ICAO API 호출',
    statusKey: 'notices',
    verdictUse: '공역 폐쇄/위험구역 주장과 공식 공지 교차 확인',
    caveat: 'SkyLink 키가 없는 경우 ICAO 계정 설정 상태에 따라 수집 범위가 제한됩니다.',
  },
  {
    id: 'aisstream',
    name: 'AISStream',
